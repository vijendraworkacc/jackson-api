...
public class Student {
	...
	public Date getsDateOfBirth() {
		return sDateOfBirth;
	}

	public void setsDateOfBirth(Date sDateOfBirth) {
	...
	public Student(int sId, String sName, int sAge, long sNumber, String sFatherName, String sMotherName,
			Set<String> sSubjects, Map<String, Integer> sSubjectMarks, Date sDateOfBirth, Address address) {
		super();
		this.sId = sId;
		this.sName = sName;
		this.sAge = sAge;
